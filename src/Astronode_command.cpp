...
astronode_answer_t Astronode_command::cfg_w(uint8_t payload_ack_bit, uint8_t add_geo_bit, uint8_t enable_ephemeris_bit, uint8_t deep_sleep_enabled_bit, uint8_t payload_ack_evt_pin_bit, uint8_t reset_notif_evt_pin_bit){
    ...
    return tr_->request_command(data);
}

astronode_answer_t Astronode_command::wif_w(std::string wlan_ssid, std::string wlan_key, std::string auth_token){
    std::cout << __PRETTY_FUNCTION__ << std::endl;
...
astronode_answer_t Astronode_command::ssc_w(uint8_t sat_period_enum, uint8_t enable_search){
    std::cout << __PRETTY_FUNCTION__ << std::endl;
...
astronode_answer_t Astronode_command::cfg_s(void){
    std::cout << __PRETTY_FUNCTION__ << std::endl;
    std::vector<uint8_t> data = {ASTRONODE_OP_CODE_CFG_SR};
    return tr_->request_command(data);
}

astronode_answer_t Astronode_command::cfg_f(void){
    std::cout << __PRETTY_FUNCTION__ << std::endl;
    std::vector<uint8_t> data = {ASTRONODE_OP_CODE_CFG_FR};
    return tr_->request_command(data);
}

astronode_answer_t Astronode_command::cfg_r(void){
    std::cout << __PRETTY_FUNCTION__ << std::endl;
...
astronode_answer_t Astronode_command::rtc_r(void){
    std::cout << __PRETTY_FUNCTION__ << std::endl;
...
astronode_answer_t Astronode_command::msn_r(void){
    std::cout << __PRETTY_FUNCTION__ << std::endl;
    std::vector<uint8_t> data = {ASTRONODE_OP_CODE_DSN_RR};
    return tr_->request_command(data);
}

astronode_answer_t Astronode_command::mpn_r() {
    std::cout << __PRETTY_FUNCTION__ << std::endl;
    std::vector<uint8_t> data = {ASTRONODE_OP_CODE_MPN_RR};
    return tr_->request_command(data);
}

astronode_answer_t Astronode_command::pld_e(uint16_t payload_id, const std::string payload_data){
    std::cout << __PRETTY_FUNCTION__ <<std::endl;
...
astronode_answer_t Astronode_command::pld_d(void){
    std::cout << __PRETTY_FUNCTION__ <<std::endl;
...
astronode_answer_t Astronode_command::pld_f(void){
    std::cout << __PRETTY_FUNCTION__ <<std::endl;
    std::vector<uint8_t> data = {ASTRONODE_OP_CODE_PLD_FR};
    return tr_->request_command(data);
}

astronode_answer_t Astronode_command::geo_w(int32_t lat, int32_t lng){
    std::cout << __PRETTY_FUNCTION__ <<std::endl;
...
astronode_answer_t Astronode_command::evt_r(void){
    std::cout << __PRETTY_FUNCTION__ <<std::endl;
...
astronode_answer_t Astronode_command::sak_r(void){
    std::cout << __PRETTY_FUNCTION__ <<std::endl;
...
astronode_answer_t Astronode_command::sak_c(void){
    std::cout << __PRETTY_FUNCTION__ <<std::endl;
    std::vector<uint8_t> data = {ASTRONODE_OP_CODE_SAK_CR};
    return tr_->request_command(data);
}

astronode_answer_t Astronode_command::cmd_r(void){
    std::cout << __PRETTY_FUNCTION__ <<std::endl;
...
astronode_answer_t Astronode_command::cmd_c(void){
    std::cout << __PRETTY_FUNCTION__ <<std::endl;
    std::vector<uint8_t> data = {ASTRONODE_OP_CODE_CMD_CR};
    return tr_->request_command(data);
}

astronode_answer_t Astronode_command::res_c(void){
    std::cout << __PRETTY_FUNCTION__ <<std::endl;
    std::vector<uint8_t> data = {ASTRONODE_OP_CODE_RES_CR};
    return tr_->request_command(data);
}

astronode_answer_t Astronode_command::val_w(void){
    std::cout << __PRETTY_FUNCTION__  << std::endl;
    std::vector<uint8_t> data = {ASTRONODE_OP_CODE_VAL_WR};
    return tr_->request_command(data);
}

astronode_answer_t Astronode_command::ttx_s(uint8_t transmit_duration_sec){
    std::cout << __PRETTY_FUNCTION__ << std::endl;
