...
class Command{
public:
    Command(std::shared_ptr<Transport> tr);
...
class Command_cfg_w : public Command{
public:
    Command_cfg_w(std::shared_ptr<Transport> tr) : Command(tr){}
...
class Command_wif_w : public Command{
public:
    Command_wif_w(std::shared_ptr<Transport> tr) : Command(tr){}
...
class Command_ssc_w : public Command{
public:
    Command_ssc_w(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(uint8_t sat_period_enum, uint8_t enable_search);
};

class Command_cfg_s : public Command{
public:
    Command_cfg_s(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
};

class Command_cfg_f : public Command{
public:
    Command_cfg_f(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
};

class Command_cfg_r : public Command{
public:
    Command_cfg_r(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
...
class Command_rtc_r : public Command{
public:
    Command_rtc_r(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
  //  std::vector<uint8_t> get_answer_parameters(void);
    uint32_t get_rtc_time(void); // TODO add method content
};

class Command_nco_r : public Command{
public:
    Command_nco_r(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
  //  std::vector<uint8_t> get_answer_parameters(void);
    uint32_t get_time_to_next_pass(void);   // TODO add method content
};

class Command_mgi_r : public Command{
public:
    Command_mgi_r(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
};

class Command_msn_r : public Command{
public:
    Command_msn_r(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
};

class Command_mpn_r : public Command{
public:
    Command_mpn_r(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
};

class Command_pld_e : public Command{
public:
    Command_pld_e(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(uint16_t payload_id, const std::string payload_data);
    uint16_t get_command_id(void);
};

class Command_pld_d : public Command{
public:
    Command_pld_d(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
    uint16_t get_command_id(void);
};

class Command_pld_f : public Command{
public:
    Command_pld_f(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);

};

class Command_geo_w : public Command{
public:
    Command_geo_w(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(std::string lat, std::string lng); // ex: lat = "465343400" for 46.53434
};

class Command_evt_r : public Command{
public:
    Command_evt_r(std::shared_ptr<Transport> tr): Command(tr){}
    void request_cmd(void);
...
class Command_sak_r : public Command{
public:
    Command_sak_r(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
    uint16_t get_command_id(void);
};

class Command_sak_c : public Command{
public:
    Command_sak_c(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
};

class Command_cmd_r : public Command{
public:
    Command_cmd_r(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
    uint32_t get_created_date(void);
    std::vector<uint8_t> get_payload(void);
};

class Command_cmd_c : public Command{
public:
    Command_cmd_c(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
};

class Command_res_c : public Command{
public:
    Command_res_c(std::shared_ptr<Transport> tr) : Command(tr){}
    void request_cmd(void);
};